...
from diffusers import DDPMNoiseShiftScheduler as DDPMScheduler
...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "The name of pt file that prior mean tensor is saved."
        ),
    )
        ...
        if accelerator.is_main_process:
            if epoch % args.save_images_epochs == 0 or epoch == args.num_epochs - 1:
                ...
                prior_labels = (
                    ...
                    .unsqueeze(1)
                    .expand(prior_means.shape[0], args.eval_batch_size)
                    .reshape(-1)
                )
                ...
                save_images_grid_np(images_processed, grid_size=(prior_means.shape[0], args.eval_batch_size), output_path=save_path)
